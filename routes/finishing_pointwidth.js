...
router.post("/finishing_pointwidth", (req, res) => {
  ...
  console.log({WIP, J, P, YI, AO, L, A9, B3, WG})
  ...
  if (metric) {
    newWOP = convertToEnglish(WOP)
    newWIP = convertToEnglish(WIP)
    var num1 = 0.0762
  }
  ...
  if(WOP < WIP){
      //1440
      console.log("CALC. PINTION FIN. LIMIT P.W.   " + "Wlp (WOP)=  " + newWOP)
      var WLP = WOP
      var WMP = WIP //1500
      ...
      console.log({WBP})
      if (metric) {
        var newWBP = convertToEnglish(WBP)
        var newWMP = convertToEnglish(WMP)
      }
      console.log({WBP})
      console.log("SEE CUTTER SPECS TABLE-THEO. BLD. PT.FOR PIN.CUTTER =  " + newWBP)
      console.log("WHAT PINION. FIN. P.W.  ")
      console.log("INPUT PINION BLD.PT.  ")
      console.log("INPUT GEAR BLD.PT.  ")

      res.render('homepage_PW1', {newWOP, newWMP, newWBP});
    }
  else{
      console.log("CALC. PINION FIN. LIMIT P.W.   " + "Wlp (WIP) = " + newWIP)
      var WLP = WIP
      var WMP = WOP
      console.log("MAX. PINION SLOT WIDTH= " + WMP)
      // if (metric) {
      //   var newWMP = convertToMetric(WMP)
      // }
      
      var WBP = WMP / 2 + num1

      console.log({WMP, num1})
      console.log({WBP})
      if (metric) {
        var newWBP = convertToEnglish(WBP)
        var newWMP = convertToEnglish(WMP)
      ...
      console.log("INPUT PINION BLD.PT.  ")
      console.log("INPUT GEAR BLD.PT.  ")
      res.render('homepage_PW2', {newWIP, newWMP, newWBP});
  }
