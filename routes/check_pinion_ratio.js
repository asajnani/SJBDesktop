...
router.post("/check_pinion_ratio", (req, res) => {
  ...
  var pg1 = Number(req.body.pinion1)
  // var pg2 = Number(req.body.pinion2)
  // var pg3 = Number(req.body.pinion3)
  // var pg4 = Number(req.body.pinion4)

  // var H0 = check_ratio1(pg1, pg2, pg3, pg4, M50P)

  var H0 = Math.abs(pg1 - M50P)
  ...
  if(H0 > 0.0001){
    ...
    res.render('homepage_wrongGear', {M50P});
  } 
  else {
    //2125 
    console.log("NC/50 RATIO FOR GEAR IS " + M50G)

    res.render('homepage_gRatio', {M50G});
  ...
  temp.variables[0]["pg1"] = pg1
  // temp.variables[0]["pg2"] = pg2
  // temp.variables[0]["pg3"] = pg3
  // temp.variables[0]["pg4"] = pg4
