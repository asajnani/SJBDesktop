...
//820 GO SUB 8000
  ...
  if(heel){
    var toothMeasurementAt = "HEEL"
  } else {
    var toothMeasurementAt = "MIDFACE"
  }
  ...
  var PI, L, M, N, O, SA, D1, D2, PAP, PAG, P, A3, F, H0 = null
  ...
  var AO = D2 / (2 * Math.sin(PAG))

  outerconeflag = 0

  console.log({outerconeflag})

  console.log({AO, D2, PAG})

  P = 3.1416 / PD1

  console.log({P, PI, PD1})
  ...
  //temp.variables[0]["Y1"] = Y1
  temp.variables[0]["AO"] = AO
  temp.variables[0]["outerconeflag"] = outerconeflag
  temp.variables[0]["toothMeasurementAt"] = toothMeasurementAt
